...
def start_api_server():
    """Start FastAPI server with  tunnel"""

    print("\n🚀 Starting FastAPI Server...")
    print("-" * 70)

    # Set up  tunnel
    .set_auth_token("YOUR__TOKEN")  # Replace with your token
    public_url = .connect(8000)
    ...
    print("\n⚠️  Note: Replace 'YOUR__TOKEN' with actual token")
    print("-" * 70)
